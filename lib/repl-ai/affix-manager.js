...
class AffixManager
{
    ...
    getSuffixDataOf(response)
    {
        ...
        ret.rememberName = this.replyeeData.remember_name;
        ...
        try {
            ...
            resJson = JSON.parse(ret.suffixString);
        } catch (e) {
        ...
        // 名前覚えたか判定
        if (resJson.hasOwnProperty('feedback') && resJson.feedback.hasOwnProperty('remember_name')) {
            console.log("名前覚えた");
            ret.rememberName = resJson.feedback.remember_name;
        }
        return ret;
    }
